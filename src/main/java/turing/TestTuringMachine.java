...
/**
 * A test program for the TuringMachine class.
 *
 * <p>It creates three machines and runs them. The output from the program indicates the expected
 * behavior.
 */
public class TestTuringMachine {
  ...
  public static void main(String[] args) {
    ...
    writeMachine.addRules(
        new Rule[] { // writes Hello on the tape then halts
    ...
    badMachine.addRules(
        new Rule[] { // writes ERROR on the tape then fails
          new Rule(0, ' ', 1, 'R', true),
          new Rule(1, ' ', 2, 'O', true),
          new Rule(2, ' ', 3, 'R', true),
          new Rule(3, ' ', 4, 'R', true),
