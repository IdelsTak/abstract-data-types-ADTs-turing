 ...
 *
 * <p>The output from this program should be:
 *
 * <p>{@code Tape Contents: Hello World}
 *
 * <p>{@code Final position at the W}
 */
public class TestTape {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < "Hello World".length(); i++) tape.moveLeft();
